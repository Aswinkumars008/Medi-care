...
$licenseno = mysqli_real_escape_string($this->db->link, $data['licenseno']);

$photo = mysqli_real_escape_string($this->db->link, $data['photo']);

if ($name == "" || $address == "" || $city == "" || $country == "" || $zip == "" || $phone == "" || $email == "" || $pass == ""|| $licenseno == ""|| $photo == "") {
  ...
  if ($mailchk != false) {
	...
	return $msg;
  	 ...
  	 $query = "INSERT INTO tbl_customer(name,address,city,country,zip,phone,email,pass,licenseno,photo) VALUES('$name','$address','$city','$country','$zip','$phone','$email','$pass','$licenseno','$photo')";
